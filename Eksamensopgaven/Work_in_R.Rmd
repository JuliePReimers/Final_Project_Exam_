...
# Visualization showing number of articles published in 1864
(Marchus and Nikolaj)
...
# Visualization showing sentiment analysis in the different regions 1864
(Ditte)
...
# Visualization showing the amount of published articles each year 
(Ditte)
Now we create a visualization showing the amount of published articles in the individually years

```{r visualization showing the amount of published articles each years}
ggplot()+ 
...
# Visualization showing the publisher of the articles each year
(Marchus and Nikolaj)
...
ggplot(data = mean_sentiment_1866)+ 
  geom_col(aes(x = mean_sentiment, y = lplace))+
  ggtitle("Average sentiment in articles based on location of publication 1866")+ 
  xlab("Location")+
  ylab("Average sentida-score for articles published in each city")
```
...
ggplot(data = mean_sentiment_1868)+ 
  geom_col(aes(x = mean_sentiment, y = lplace))+
  ggtitle("Average sentiment in articles based on location of publication 1868")+ 
  xlab("Location")+
  ylab("Average sentida-score for articles published in each city")
```
...
# Visualization showing sentiment values for the historian texts
(Julie)
